...
public class SysLogServiceImpl extends AbstractService<SysLog> implements SysLogService {
    ...
    public List<SysLogOutpDTO> list(PageParam pageParam, SysLogInputDTO inputDTO) {
        ...
        // if (StringUtils.isNotEmpty(inputDTO.getStartTime())){
        //     example.and().andGreaterThanOrEqualTo("startTime", inputDTO.getStartTime());
        // }
        // if (StringUtils.isNotEmpty(inputDTO.getEndTime())){
        //     example.and().andLessThanOrEqualTo("endTime", inputDTO.getEndTime());
        // }
        // if (StringUtils.getLogUser())){
        //     example.and().andLike("logType", "%" + inputDTO.getLogType() +"%");
        // }
        // if (StringUtils.isNotEmpty(inputDTO.getEndTime())){
        //     example.and().andLessThanOrEqualTo("endTime", inputDTO.getStartTime());
        // }
