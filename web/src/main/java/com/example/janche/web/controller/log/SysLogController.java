...
public class SysLogController {
    ...
    @PutMapping
    @ApiOperation(value = "修改日志", notes = "单个修改" , produces = "application/json")
    ...
    @GetMapping
    @ApiOperation(value = "获取日志信息", notes = "单个获取", produces = "application/json")
    ...
    @ApiOperation(value = "日志列表分页查询", notes = "分页列表", produces = "application/json")
    ...
    @ApiOperation(value = "日志列表查询所有", notes = "下拉框列表", produces = "application/json") // TODO
    ...
    @ApiOperation(value = "导出日志列表", notes = "导出报表", produces = "application/json")
